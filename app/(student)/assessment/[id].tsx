...
import {
  ...
  fetchQuestions,
  submitAssessment,
} from '../../../src/redux/slices/assessmentSlice';
import {
  fetchAssessmentDetails,
  type AssessmentDetails,
} from '../../../src/services';
import { useTheme } from '../../../src/theme';
import { formatDuration, formatSeconds } from '../../../src/utils';
        ...
        <Card variant="elevated" padding="lg">
          <View style={{ gap: 16 }}>
            ...
            <Button
              ...
              onPress={() => router.replace('/(student)/(tabs)/assessments')}
              fullWidth
            />
          </View>
        </Card>
        ...
        <Card variant="elevated" padding="lg">
          <View style={{ gap: 16 }}>
            ...
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
              ...
              />
              <Badge
                label={`${details?.total_marks ?? 0} marks`}
                variant="neutral"
              />
              <Badge
        ...
        <View style={{ gap: 16 }}>
          <Card variant="elevated" padding="lg">
            <View style={{ gap: 14 }}>
              ...
              <ProgressBar
                progress={(answeredCount / currentQuestions.length) * 100}
                showLabel
              />
