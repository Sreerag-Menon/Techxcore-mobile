...
export const ENDPOINTS = {
  AUTH: {
    ...
    CHANGE_PASSWORD_V2: '/change_member_password_v2',
  ...
  DASHBOARD: {
    ...
    LIVE_SESSION_PROGRESS: '/get_trainee_live_session_dtl',
  ...
  USER: {
    ...
    MEMBER_SKILLS: '/get_member_skills',
    JOB_SKILLS: '/get_job_skills',
    INSERT_JOB_DETAILS: '/insert_update_job_details',
    INSERT_SKILLS_DETAILS: '/insert_update_skills_details',
    TICKETS: '/get_member_tickets',
    UPDATE_TICKET_STATUS: '/update_tickets_status',
    GET_LANGUAGE: '/get_language',
    UPDATE_ACTIVE_LANGUAGE: '/update_active_language',
  },
  PARENT: {
