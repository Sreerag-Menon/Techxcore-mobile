...
export type StudyBuddyChatbotHandle = {
  open: () => void;
};
...
export const StudyBuddyChatbot = forwardRef<StudyBuddyChatbotHandle, StudyBuddyChatbotProps>(
  function StudyBuddyChatbot(
    { storageKey, endpointUrl, context, showFloatingButton = true },
    ref,
  ) {
              ...
              {messages.slice(-12).map((m) => (
                <View
                  ...
                  style={{
                    ...
                    paddingVertical: 10,
                    backgroundColor: m.role === 'user' ? colors.primary : colors.background,
                  }}
                >
